...
#     def __init__(self, task_id, profile_name, image_path, prompt, mgr, retry_count=0, batch_id=None, mode="frames"):
#         super().__init__()
...
#                 if valid_paths:
#                     sku_folder = os.path.dirname(valid_paths[0])
#                 else:
#                     sku_folder = os.path.join(self.mgr.base_path, "Text_To_Video_Factory")

#                 # --- XỬ LÝ NHÓM FOLDER (BATCH ID) ---
#                 # Nếu MainWindow đã cấp batch_id (ví dụ: Batch_173005) thì dùng luôn
#                 # Nếu không có (card tạo tay), mới tự sinh Run_xxxxx
...
#                     mode=self.mode, 
#                     model_type="Lite", 
#                     batch_id=current_run_id # Gửi ID nhóm vào FlowPage để tạo folder
#                 )
